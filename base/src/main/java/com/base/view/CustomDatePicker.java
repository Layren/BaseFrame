...
public class CustomDatePicker {
    ...
    private TextView tv_cancle, tv_select, year_text, month_text, hour_text, minute_text;
    ...
    public void setDateTime(String startDate, String endDate) throws Exception {
        if (isValidDate(startDate, "yyyy-MM-dd HH:mm") && isValidDate(endDate, "yyyy-MM-dd HH:mm")) {
            ...
            throw new Exception("startDate or endDate format Error in setDateTime");
        }
    }
