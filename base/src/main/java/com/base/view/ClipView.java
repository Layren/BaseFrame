...
public class ClipView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        } else if (clipType == ClipType.SQUARE) { //绘制正方形裁剪框
            //绘制中间的矩形
            canvas.drawRect(mHorizontalPadding, this.getHeight() / 2 - clipWidth / 2 / ratio,
                    this.getWidth() - mHorizontalPadding, this.getHeight() / 2 + clipWidth / 2 / ratio, paint);
            //绘制白色的矩形边框
            canvas.drawRect(mHorizontalPadding, this.getHeight() / 2 - clipWidth / 2 / ratio,
     ...
     * @return
     */
    public Rect getClipRect(float ratio) {
        Rect rect = new Rect();
        //宽度的一半 - 圆的半径
        ...
        //高度的一半 - 圆的半径
        rect.top = (int) (this.getHeight() / 2 - clipRadiusWidth * ratio);
        //高度的一半 + 圆的半径
        rect.bottom = (int) (this.getHeight() / 2 + clipRadiusWidth * ratio);
        return rect;
    }
    ...
    public void setmHorizontalPadding(float mHorizontalPadding) {
        ...
        this.clipWidth = (int) (clipRadiusWidth * 2);
    }
