...
import com.scanner.common.BitmapUtils;
import com.scanner.config.Config;
import com.scanner.decode.BitmapDecoder;
...
public final class CaptureActivity extends BaseActivity implements
    ...
    protected void initView() {
        ...
        String key = getIntent().getStringExtra("context");
        call = QRCodeUtils.getInstance().getCall(key);
        hasSurface = false;
    ...
    protected void onResume() {
        ...
        viewfinderView.setRectEdgeBitmaps(BitmapFactory.decodeResource(getResources(),
                ...
                BitmapFactory.decodeResource(getResources(),
                        R.drawable.scan_corner_bottom_right));
        //设置扫描框激光线
        viewfinderView.setScanningLineBitmap(((BitmapDrawable) getResources().getDrawable(R.drawable.scan_laser)).getBitmap());
        handler = null;
        lastResult = null;
...
//        viewfinderView.drawResultBitmap(barcode);
    ...
    public void restartPreviewAfterDelay(long delayMS) {
        if (handler != null) {
            handler.sendEmptyMessageDelayed(Config.ID_RESTART_PREVIEW, delayMS);
        }
        resetStatusView();
    }
        ...
        if (handler == null) {
            ...
            if (savedResultToShow != null) {
                Message message = Message.obtain(handler,
                        Config.ID_DECODE_SUCCESSED, savedResultToShow);
